        ...
        <Collapse isOpen={isOpen} navbar className="justify-content-end">
            ...
            <div style={{display:props.hideButtons ? 'none' : null}} className={'MiniBar'}>
                <Dropdown 
                  ...
                  <small style={{color:'white', paddingLeft:'18px', fontSize:'11px'}}>Global</small>
                    ...
                    <small style={{color:'white', paddingLeft:'12px', fontSize:'11px'}}>Personal</small>
                    ...
                    <small style={{color:'white', paddingLeft:'19px', fontSize:'11px'}}>Profile</small>
