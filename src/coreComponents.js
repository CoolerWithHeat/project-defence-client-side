...
export function MainBoard(){
    ...
    const changeMode = (data)=>{
        Update_nightMode(data.target.checked)
        const body = document.getElementsByTagName('body')
        body[0].style.backgroundColor = data.target.checked ? '#262323' : 'white'
        localStorage.setItem('nightMode', data.target.checked)
    }
                    ...
                    <nav className="nav">
                        <div>
                            <div className="nav_list"> 
                                <small style={{textAlign:'center', color:'white', paddingLeft:'18px', fontSize:'11px'}}>{translations['globalbutton']}</small>
                                ...
                                <small style={{textAlign:'center', color:'white', paddingLeft:'12px', fontSize:'11px'}}>{translations['personalbutton']}</small>
                                ...
                                <small style={{color:'white', paddingLeft:'19px', fontSize:'11px'}}>{translations['profilebutton']}</small>
